...
class CreateOrderCreateSubscriptionTerms(object):
    ...
    def __init__(self, auto_renew=None, initial_term=None, renewal_setting=None, renewal_terms=None):  # noqa: E501
        """CreateOrderCreateSubscriptionTerms - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def auto_renew(self):
        """Gets the auto_renew of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
        ...
        :return: The auto_renew of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_renew(self, auto_renew):
        """Sets the auto_renew of this CreateOrderCreateSubscriptionTerms.

        Specifies whether the subscription automatically renews at the end of the each term. Only applicable if the type of the first term is `TERMED`.   # noqa: E501

        :param auto_renew: The auto_renew of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
        :type: bool
        """
    ...
    def initial_term(self):
        """Gets the initial_term of this CreateOrderCreateSubscriptionTerms.  # noqa: E501


        :return: The initial_term of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
    ...
    def initial_term(self, initial_term):
        """Sets the initial_term of this CreateOrderCreateSubscriptionTerms.


        :param initial_term: The initial_term of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
    ...
    def renewal_setting(self):
        """Gets the renewal_setting of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
        ...
        :return: The renewal_setting of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
        :rtype: str
        """
    ...
    def renewal_setting(self, renewal_setting):
        """Sets the renewal_setting of this CreateOrderCreateSubscriptionTerms.

        Specifies the type of the terms that follow the first term if the subscription is renewed. Only applicable if the type of the first term is `TERMED`.  * `RENEW_WITH_SPECIFIC_TERM` - Each renewal term has a predefined duration. The first entry in `renewalTerms` specifies the duration of the second term of the subscription, the second entry in `renewalTerms` specifies the duration of the third term of the subscription, and so on. The last entry in `renewalTerms` specifies the ultimate duration of each renewal term. * `RENEW_TO_EVERGREEN` - The second term of the subscription does not have a predefined duration.   # noqa: E501

        :param renewal_setting: The renewal_setting of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
        :type: str
        """
    ...
    def renewal_terms(self):
        """Gets the renewal_terms of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
        ...
        :return: The renewal_terms of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
    ...
    def renewal_terms(self, renewal_terms):
        """Sets the renewal_terms of this CreateOrderCreateSubscriptionTerms.

        List of renewal terms of the subscription. Only applicable if the type of the first term is `TERMED` and the value of the `renewalSetting` field is `RENEW_WITH_SPECIFIC_TERM`.   # noqa: E501

        :param renewal_terms: The renewal_terms of this CreateOrderCreateSubscriptionTerms.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateOrderCreateSubscriptionTerms, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOrderCreateSubscriptionTerms):
            return False
