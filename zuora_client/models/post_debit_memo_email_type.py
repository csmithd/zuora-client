...
class PostDebitMemoEmailType(object):
    ...
    def __init__(self, email_addresses=None, include_additional_email_addresses=False, use_email_template_setting=False):  # noqa: E501
        """PostDebitMemoEmailType - a model defined in Swagger"""  # noqa: E501
    ...
    def email_addresses(self):
        """Gets the email_addresses of this PostDebitMemoEmailType.  # noqa: E501

        The valid email addresses you want to email a debit memo to. Use commas to separate email addresses.  **Note:** This field is only applicable if you set the `useEmailTemplateSetting` field to `false`.   # noqa: E501

        :return: The email_addresses of this PostDebitMemoEmailType.  # noqa: E501
        :rtype: str
        """
    ...
    def email_addresses(self, email_addresses):
        """Sets the email_addresses of this PostDebitMemoEmailType.

        The valid email addresses you want to email a debit memo to. Use commas to separate email addresses.  **Note:** This field is only applicable if you set the `useEmailTemplateSetting` field to `false`.   # noqa: E501

        :param email_addresses: The email_addresses of this PostDebitMemoEmailType.  # noqa: E501
        :type: str
        """
    ...
    def include_additional_email_addresses(self):
        """Gets the include_additional_email_addresses of this PostDebitMemoEmailType.  # noqa: E501
        ...
        :return: The include_additional_email_addresses of this PostDebitMemoEmailType.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_additional_email_addresses(self, include_additional_email_addresses):
        """Sets the include_additional_email_addresses of this PostDebitMemoEmailType.

        Indicates whether to send a debit memo to the additional email addresses of the memo account.    You can set the additional email addresses in the **Additional Email Addresses** field on the account detail page from the Zuora UI. See [Create a Customer Account](https://knowledgecenter.zuora.com/BC_Subscription_Management/Customer_Accounts/B_Create_a_Customer_Account#section_2) for more information.   # noqa: E501

        :param include_additional_email_addresses: The include_additional_email_addresses of this PostDebitMemoEmailType.  # noqa: E501
        :type: bool
        """
    ...
    def use_email_template_setting(self):
        """Gets the use_email_template_setting of this PostDebitMemoEmailType.  # noqa: E501
        ...
        :return: The use_email_template_setting of this PostDebitMemoEmailType.  # noqa: E501
        :rtype: bool
        """
    ...
    def use_email_template_setting(self, use_email_template_setting):
        """Sets the use_email_template_setting of this PostDebitMemoEmailType.

        Indicates whether to email a debit memo based on the email template setting.   If you set this field to `true`, the debit memo is sent to the email addresses specified in the **To Email** field of the email template. The email template is the one you set in the **Delivery Options** panel of the **Edit notification** dialog from the Zuora UI. See [Edit Email Templates](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/Notifications/Create_Email_Templates) for more information about how to edit the **To Email** field in the email template.   # noqa: E501

        :param use_email_template_setting: The use_email_template_setting of this PostDebitMemoEmailType.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostDebitMemoEmailType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostDebitMemoEmailType):
            return False
