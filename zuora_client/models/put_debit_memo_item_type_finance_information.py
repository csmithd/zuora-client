...
class PUTDebitMemoItemTypeFinanceInformation(object):
    ...
    def __init__(self, deferred_revenue_accounting_code=None, recognized_revenue_accounting_code=None, revenue_recognition_rule_name=None):  # noqa: E501
        """PUTDebitMemoItemTypeFinanceInformation - a model defined in Swagger"""  # noqa: E501
    ...
    def deferred_revenue_accounting_code(self):
        """Gets the deferred_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501

        The accounting code for the deferred revenue, such as Monthly Recurring Liability.   # noqa: E501

        :return: The deferred_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def deferred_revenue_accounting_code(self, deferred_revenue_accounting_code):
        """Sets the deferred_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.

        The accounting code for the deferred revenue, such as Monthly Recurring Liability.   # noqa: E501

        :param deferred_revenue_accounting_code: The deferred_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def recognized_revenue_accounting_code(self):
        """Gets the recognized_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501

        The accounting code for the recognized revenue, such as Monthly Recurring Charges or Overage Charges.   # noqa: E501

        :return: The recognized_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def recognized_revenue_accounting_code(self, recognized_revenue_accounting_code):
        """Sets the recognized_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.

        The accounting code for the recognized revenue, such as Monthly Recurring Charges or Overage Charges.   # noqa: E501

        :param recognized_revenue_accounting_code: The recognized_revenue_accounting_code of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def revenue_recognition_rule_name(self):
        """Gets the revenue_recognition_rule_name of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501

        The name of the revenue recognition rule governing the revenue schedule.   # noqa: E501

        :return: The revenue_recognition_rule_name of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def revenue_recognition_rule_name(self, revenue_recognition_rule_name):
        """Sets the revenue_recognition_rule_name of this PUTDebitMemoItemTypeFinanceInformation.

        The name of the revenue recognition rule governing the revenue schedule.   # noqa: E501

        :param revenue_recognition_rule_name: The revenue_recognition_rule_name of this PUTDebitMemoItemTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PUTDebitMemoItemTypeFinanceInformation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PUTDebitMemoItemTypeFinanceInformation):
            return False
