...
class UsageTieredWithOveragePricingUpdate(object):
    ...
    def __init__(self, price_change_option=None, price_increase_percentage=None, overage_price=None, tiers=None):  # noqa: E501
    ...
    def price_change_option(self):
        """Gets the price_change_option of this UsageTieredWithOveragePricingUpdate.  # noqa: E501
        ...
        :return: The price_change_option of this UsageTieredWithOveragePricingUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def price_change_option(self, price_change_option):
        """Sets the price_change_option of this UsageTieredWithOveragePricingUpdate.

        Specifies how Zuora changes the price of the charge each time the subscription renews.  If the value of this field is `SpecificPercentageValue`, use the `priceIncreasePercentage` field to specify how much the price of the charge should change.   # noqa: E501

        :param price_change_option: The price_change_option of this UsageTieredWithOveragePricingUpdate.  # noqa: E501
        :type: str
        """
    ...
    def price_increase_percentage(self):
        """Gets the price_increase_percentage of this UsageTieredWithOveragePricingUpdate.  # noqa: E501
        ...
        :return: The price_increase_percentage of this UsageTieredWithOveragePricingUpdate.  # noqa: E501
        :rtype: float
        """
    ...
    def price_increase_percentage(self, price_increase_percentage):
        """Sets the price_increase_percentage of this UsageTieredWithOveragePricingUpdate.

        Specifies the percentage by which the price of the charge should change each time the subscription renews. Only applicable if the value of the `priceChangeOption` field is `SpecificPercentageValue`.   # noqa: E501

        :param price_increase_percentage: The price_increase_percentage of this UsageTieredWithOveragePricingUpdate.  # noqa: E501
        :type: float
        """
