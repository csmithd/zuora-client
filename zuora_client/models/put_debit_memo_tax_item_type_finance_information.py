...
class PutDebitMemoTaxItemTypeFinanceInformation(object):
    ...
    def __init__(self, sales_tax_payable_accounting_code=None):  # noqa: E501
        """PutDebitMemoTaxItemTypeFinanceInformation - a model defined in Swagger"""  # noqa: E501
    ...
    def sales_tax_payable_accounting_code(self):
        """Gets the sales_tax_payable_accounting_code of this PutDebitMemoTaxItemTypeFinanceInformation.  # noqa: E501

        The accounting code for the sales taxes payable.   # noqa: E501

        :return: The sales_tax_payable_accounting_code of this PutDebitMemoTaxItemTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def sales_tax_payable_accounting_code(self, sales_tax_payable_accounting_code):
        """Sets the sales_tax_payable_accounting_code of this PutDebitMemoTaxItemTypeFinanceInformation.

        The accounting code for the sales taxes payable.   # noqa: E501

        :param sales_tax_payable_accounting_code: The sales_tax_payable_accounting_code of this PutDebitMemoTaxItemTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PutDebitMemoTaxItemTypeFinanceInformation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PutDebitMemoTaxItemTypeFinanceInformation):
            return False
