...
class PaymentObjectNSFields(object):
    ...
    def __init__(self, integration_id__ns=None, integration_status__ns=None, origin__ns=None, sync_date__ns=None, transaction__ns=None):  # noqa: E501
        """PaymentObjectNSFields - a model defined in Swagger"""  # noqa: E501
    ...
    def integration_id__ns(self):
        """Gets the integration_id__ns of this PaymentObjectNSFields.  # noqa: E501

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :return: The integration_id__ns of this PaymentObjectNSFields.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_id__ns(self, integration_id__ns):
        """Sets the integration_id__ns of this PaymentObjectNSFields.

        ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_id__ns: The integration_id__ns of this PaymentObjectNSFields.  # noqa: E501
        :type: str
        """
    ...
    def integration_status__ns(self):
        """Gets the integration_status__ns of this PaymentObjectNSFields.  # noqa: E501
        ...
        :return: The integration_status__ns of this PaymentObjectNSFields.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_status__ns(self, integration_status__ns):
        """Sets the integration_status__ns of this PaymentObjectNSFields.

        Status of the payment's synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param integration_status__ns: The integration_status__ns of this PaymentObjectNSFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def origin__ns(self):
        """Gets the origin__ns of this PaymentObjectNSFields.  # noqa: E501
        ...
        :return: The origin__ns of this PaymentObjectNSFields.  # noqa: E501
        :rtype: str
        """
    ...
    def origin__ns(self, origin__ns):
        """Sets the origin__ns of this PaymentObjectNSFields.

        Origin of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param origin__ns: The origin__ns of this PaymentObjectNSFields.  # noqa: E501
        :type: str
        """
    ...
    def sync_date__ns(self):
        """Gets the sync_date__ns of this PaymentObjectNSFields.  # noqa: E501
        ...
        :return: The sync_date__ns of this PaymentObjectNSFields.  # noqa: E501
        :rtype: str
        """
    ...
    def sync_date__ns(self, sync_date__ns):
        """Sets the sync_date__ns of this PaymentObjectNSFields.

        Date when the payment was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param sync_date__ns: The sync_date__ns of this PaymentObjectNSFields.  # noqa: E501
        :type: str
        """
    ...
    def transaction__ns(self):
        """Gets the transaction__ns of this PaymentObjectNSFields.  # noqa: E501
        ...
        :return: The transaction__ns of this PaymentObjectNSFields.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction__ns(self, transaction__ns):
        """Sets the transaction__ns of this PaymentObjectNSFields.

        Related transaction in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).   # noqa: E501

        :param transaction__ns: The transaction__ns of this PaymentObjectNSFields.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaymentObjectNSFields, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentObjectNSFields):
            return False
