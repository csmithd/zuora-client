...
class PostNonRefRefundTypeFinanceInformation(object):
    ...
    def __init__(self, bank_account_accounting_code=None, on_account_accounting_code=None, transferred_to_accounting=None, unapplied_payment_accounting_code=None):  # noqa: E501
        """PostNonRefRefundTypeFinanceInformation - a model defined in Swagger"""  # noqa: E501
    ...
    def bank_account_accounting_code(self):
        """Gets the bank_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501

        The accounting code that maps to a bank account in your accounting system.   # noqa: E501

        :return: The bank_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def bank_account_accounting_code(self, bank_account_accounting_code):
        """Sets the bank_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.

        The accounting code that maps to a bank account in your accounting system.   # noqa: E501

        :param bank_account_accounting_code: The bank_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def on_account_accounting_code(self):
        """Gets the on_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501

        The accounting code that maps to an on account in your accounting system.   # noqa: E501

        :return: The on_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def on_account_accounting_code(self, on_account_accounting_code):
        """Sets the on_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.

        The accounting code that maps to an on account in your accounting system.   # noqa: E501

        :param on_account_accounting_code: The on_account_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def transferred_to_accounting(self):
        """Gets the transferred_to_accounting of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        ...
        :return: The transferred_to_accounting of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def transferred_to_accounting(self, transferred_to_accounting):
        """Sets the transferred_to_accounting of this PostNonRefRefundTypeFinanceInformation.

        Whether the refund was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.    # noqa: E501

        :param transferred_to_accounting: The transferred_to_accounting of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def unapplied_payment_accounting_code(self):
        """Gets the unapplied_payment_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501

        The accounting code for the unapplied payment.   # noqa: E501

        :return: The unapplied_payment_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def unapplied_payment_accounting_code(self, unapplied_payment_accounting_code):
        """Sets the unapplied_payment_accounting_code of this PostNonRefRefundTypeFinanceInformation.

        The accounting code for the unapplied payment.   # noqa: E501

        :param unapplied_payment_accounting_code: The unapplied_payment_accounting_code of this PostNonRefRefundTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostNonRefRefundTypeFinanceInformation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostNonRefRefundTypeFinanceInformation):
            return False
