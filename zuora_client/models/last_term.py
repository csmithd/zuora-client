...
class LastTerm(object):
    ...
    def period(self, period):
        ...
        :type: int
        """
        if period is not None and period > 100:  # noqa: E501
            raise ValueError("Invalid value for `period`, must be a value less than or equal to `100`")  # noqa: E501
        if period is not None and period < 0:  # noqa: E501
            raise ValueError("Invalid value for `period`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def start_date(self):
        ...
        The start date of the last term. You are not allowed to change the term start date after you have made the 'RenewSubscription' order action.   # noqa: E501
