...
class POSTJournalRunTransactionType(object):
    ...
    def __init__(self, type=None):  # noqa: E501
        """POSTJournalRunTransactionType - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this POSTJournalRunTransactionType.  # noqa: E501
        ...
        :return: The type of this POSTJournalRunTransactionType.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this POSTJournalRunTransactionType.

        Transaction type. Invoice Adjustment is deprecated on Production. Zuora recommends that you use the Invoice Item Adjustment instead.  If you enable the Invoice Settlement feature, Debit Memo Item, Credit Memo Item, and Credit Memo Application Item are available, Payment and Refund will be replaced by Payment Application and Refund Application.   If you enable both the Invoice Settlement feature and the Invoice Item Settlement feature, Payment and Refund will be replaced by Payment Application Item and Refund Application Item.    # noqa: E501

        :param type: The type of this POSTJournalRunTransactionType.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(POSTJournalRunTransactionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, POSTJournalRunTransactionType):
            return False
