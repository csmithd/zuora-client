...
class CreatePaymentTypeFinanceInformation(object):
    ...
    def __init__(self, bank_account_accounting_code=None, transferred_to_accounting=None, unapplied_payment_accounting_code=None):  # noqa: E501
        """CreatePaymentTypeFinanceInformation - a model defined in Swagger"""  # noqa: E501
    ...
    def bank_account_accounting_code(self):
        """Gets the bank_account_accounting_code of this CreatePaymentTypeFinanceInformation.  # noqa: E501

        The accounting code that maps to a bank account in your accounting system.   # noqa: E501

        :return: The bank_account_accounting_code of this CreatePaymentTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def bank_account_accounting_code(self, bank_account_accounting_code):
        """Sets the bank_account_accounting_code of this CreatePaymentTypeFinanceInformation.

        The accounting code that maps to a bank account in your accounting system.   # noqa: E501

        :param bank_account_accounting_code: The bank_account_accounting_code of this CreatePaymentTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def transferred_to_accounting(self):
        """Gets the transferred_to_accounting of this CreatePaymentTypeFinanceInformation.  # noqa: E501
        ...
        :return: The transferred_to_accounting of this CreatePaymentTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def transferred_to_accounting(self, transferred_to_accounting):
        """Sets the transferred_to_accounting of this CreatePaymentTypeFinanceInformation.

        Whether the payment was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.    # noqa: E501

        :param transferred_to_accounting: The transferred_to_accounting of this CreatePaymentTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def unapplied_payment_accounting_code(self):
        """Gets the unapplied_payment_accounting_code of this CreatePaymentTypeFinanceInformation.  # noqa: E501

        The accounting code for the unapplied payment.   # noqa: E501

        :return: The unapplied_payment_accounting_code of this CreatePaymentTypeFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def unapplied_payment_accounting_code(self, unapplied_payment_accounting_code):
        """Sets the unapplied_payment_accounting_code of this CreatePaymentTypeFinanceInformation.

        The accounting code for the unapplied payment.   # noqa: E501

        :param unapplied_payment_accounting_code: The unapplied_payment_accounting_code of this CreatePaymentTypeFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreatePaymentTypeFinanceInformation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePaymentTypeFinanceInformation):
            return False
