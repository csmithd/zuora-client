...
from zuora_client.models.charge_override_for_evergreen import ChargeOverrideForEvergreen  # noqa: F401,E501
from zuora_client.models.rate_plan_object_custom_fields import RatePlanObjectCustomFields  # noqa: F401,E501


class RatePlanOverrideForEvergreen(object):
    ...
    """
    swagger_types = {
        'charge_overrides': 'list[ChargeOverrideForEvergreen]',
    ...
    def __init__(self, charge_overrides=None, custom_fields=None, new_rate_plan_id=None, product_rate_plan_id=None, unique_token=None):  # noqa: E501
        """RatePlanOverrideForEvergreen - a model defined in Swagger"""  # noqa: E501
    ...
    def charge_overrides(self):
        """Gets the charge_overrides of this RatePlanOverrideForEvergreen.  # noqa: E501

        List of charges associated with the rate plan.   # noqa: E501

        :return: The charge_overrides of this RatePlanOverrideForEvergreen.  # noqa: E501
        :rtype: list[ChargeOverrideForEvergreen]
        """
        return self._charge_overrides

    @charge_overrides.setter
    def charge_overrides(self, charge_overrides):
        """Sets the charge_overrides of this RatePlanOverrideForEvergreen.

        List of charges associated with the rate plan.   # noqa: E501

        :param charge_overrides: The charge_overrides of this RatePlanOverrideForEvergreen.  # noqa: E501
        :type: list[ChargeOverrideForEvergreen]
        """
    ...
    def custom_fields(self):
        """Gets the custom_fields of this RatePlanOverrideForEvergreen.  # noqa: E501


        :return: The custom_fields of this RatePlanOverrideForEvergreen.  # noqa: E501
    ...
    def custom_fields(self, custom_fields):
        """Sets the custom_fields of this RatePlanOverrideForEvergreen.


        :param custom_fields: The custom_fields of this RatePlanOverrideForEvergreen.  # noqa: E501
    ...
    def new_rate_plan_id(self):
        """Gets the new_rate_plan_id of this RatePlanOverrideForEvergreen.  # noqa: E501

        Internal identifier of the rate plan.   # noqa: E501

        :return: The new_rate_plan_id of this RatePlanOverrideForEvergreen.  # noqa: E501
        :rtype: str
        """
    ...
    def new_rate_plan_id(self, new_rate_plan_id):
        """Sets the new_rate_plan_id of this RatePlanOverrideForEvergreen.

        Internal identifier of the rate plan.   # noqa: E501

        :param new_rate_plan_id: The new_rate_plan_id of this RatePlanOverrideForEvergreen.  # noqa: E501
        :type: str
        """
    ...
    def product_rate_plan_id(self):
        """Gets the product_rate_plan_id of this RatePlanOverrideForEvergreen.  # noqa: E501

        Internal identifier of the product rate plan that the rate plan is based on.   # noqa: E501

        :return: The product_rate_plan_id of this RatePlanOverrideForEvergreen.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_id(self, product_rate_plan_id):
        """Sets the product_rate_plan_id of this RatePlanOverrideForEvergreen.

        Internal identifier of the product rate plan that the rate plan is based on.   # noqa: E501

        :param product_rate_plan_id: The product_rate_plan_id of this RatePlanOverrideForEvergreen.  # noqa: E501
        :type: str
        """
    ...
    def unique_token(self):
        """Gets the unique_token of this RatePlanOverrideForEvergreen.  # noqa: E501
        ...
        :return: The unique_token of this RatePlanOverrideForEvergreen.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_token(self, unique_token):
        """Sets the unique_token of this RatePlanOverrideForEvergreen.

        Unique identifier for the rate plan. This identifier enables you to refer to the rate plan before the rate plan has an internal identifier in Zuora.  For instance, suppose that you want to use a single order to add a product to a subscription and later update the same product. When you add the product, you can set a unique identifier for the rate plan. Then when you update the product, you can use the same unique identifier to specify which rate plan to modify.   # noqa: E501

        :param unique_token: The unique_token of this RatePlanOverrideForEvergreen.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RatePlanOverrideForEvergreen, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RatePlanOverrideForEvergreen):
            return False
