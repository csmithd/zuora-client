...
class OAuthApi(object):
    ...
    def create_token_with_http_info(self, client_id, client_secret, grant_type, **kwargs):  # noqa: E501
        ...
        all_params = ['client_id', 'client_secret', 'grant_type', 'zuora_track_id']  # noqa: E501
        ...
        if ('client_id' in params and
                len(params['client_id']) > 36):
            raise ValueError("Invalid value for parameter `client_id` when calling `create_token`, length must be less than or equal to `36`")  # noqa: E501
        if ('client_id' in params and
                len(params['client_id']) < 36):
            raise ValueError("Invalid value for parameter `client_id` when calling `create_token`, length must be greater than or equal to `36`")  # noqa: E501
        if ('client_secret' in params and
                len(params['client_secret']) > 42):
            raise ValueError("Invalid value for parameter `client_secret` when calling `create_token`, length must be less than or equal to `42`")  # noqa: E501
        if ('zuora_track_id' in params and
                len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `create_token`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
