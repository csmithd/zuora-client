...
class RevenueEventsApi(object):
    ...
    def get_revenue_event_details_with_http_info(self, event_number, **kwargs):  # noqa: E501
        ...
        all_params = ['event_number', 'zuora_entity_ids']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/revenue-events/{event-number}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='GETRevenueEventDetailType',  # noqa: E501
    ...
    def get_revenue_event_for_revenue_schedule_with_http_info(self, rs_number, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/revenue-events/revenue-schedules/{rs-number}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='GETRevenueEventDetailsType',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
