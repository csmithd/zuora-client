...
# create an instance of the API class
api_instance = swagger_client.CreditMemosApi()
request = swagger_client.PostCreditMemoEmailRequestType() # PostCreditMemoEmailRequestType | 
