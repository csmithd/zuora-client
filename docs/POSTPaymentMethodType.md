...
------------ | ------------- | ------------- | -------------
**account_key** | **str** | ID of the customer account to update.  **Note:** You can create a credit card payment method without assocating it with a customer account if you want. To do it and change the &#x60;accountKey&#x60; field to optional in this operation, submit a request at [Zuora Global Support](http://support.zuora.com/).  **Important:** When you skip the &#x60;accountKey&#x60; field in this operation, the &#x60;cardHolderName&#x60; field in the cardHolderInfo object is required. | 
