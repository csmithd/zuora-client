This client is used by [payments-service](https://github.com/oreillymedia/payments-service) and the SOLO team.
...
*InvoicesApi* | [**g_et_taxation_items_of_invoice_item**](docs/InvoicesApi.md#g_et_taxation_items_of_invoice_item) | **GET** /v1/invoices/{invoice-id}/items/{item-id}/taxation-items | Get taxation items of invoice item
...
*LinkQueriesApi* | [**d_elete_link_query_job**](docs/LinkQueriesApi.md#d_elete_link_query_job) | **DELETE** /query/jobs/{job-id} | Cancel Link query job
*LinkQueriesApi* | [**g_et_link_query_job**](docs/LinkQueriesApi.md#g_et_link_query_job) | **GET** /query/jobs/{job-id} | Get Link query job
*LinkQueriesApi* | [**g_et_link_query_jobs**](docs/LinkQueriesApi.md#g_et_link_query_jobs) | **GET** /query/jobs | Get Link query jobs
*LinkQueriesApi* | [**p_ost_link_query_job**](docs/LinkQueriesApi.md#p_ost_link_query_job) | **POST** /query/jobs | Submit Link query
...
*OrdersApi* | [**g_et_job_status_and_response**](docs/OrdersApi.md#g_et_job_status_and_response) | **GET** /async-jobs/{jobId} | Get job status and response
...
*OrdersApi* | [**p_ost_create_order_asynchronously**](docs/OrdersApi.md#p_ost_create_order_asynchronously) | **POST** /async/orders | Create order asynchronously
...
*OrdersApi* | [**p_ost_preview_order_asynchronously**](docs/OrdersApi.md#p_ost_preview_order_asynchronously) | **POST** /async/orders/preview | Preview order asynchronously
...
## Documentation For Models
 ...
 - [DeleteLinkQueryJobResponse](docs/DeleteLinkQueryJobResponse.md)
 ...
 - [GetLinkQueryJobResponse](docs/GetLinkQueryJobResponse.md)
 - [GetLinkQueryJobsResponse](docs/GetLinkQueryJobsResponse.md)
 ...
 - [LinkQueryErrorResponse](docs/LinkQueryErrorResponse.md)
 - [LinkQueryJobCommon](docs/LinkQueryJobCommon.md)
 ...
 - [SubmitLinkQueryRequest](docs/SubmitLinkQueryRequest.md)
 - [SubmitLinkQueryRequestOutput](docs/SubmitLinkQueryRequestOutput.md)
 - [SubmitLinkQueryResponse](docs/SubmitLinkQueryResponse.md)
 ...
 - [LinkQueryJob](docs/LinkQueryJob.md)
 - [LinkQueryJobCancelled](docs/LinkQueryJobCancelled.md)
