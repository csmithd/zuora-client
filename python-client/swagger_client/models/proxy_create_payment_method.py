...
class ProxyCreatePaymentMethod(object):
    ...
    def skip_validation(self):
        ...
        If you set this field to true, Zuora will create the payment method without making Authorization calls to the gateway. The static field value check will remain as is. **Character limit**: 5 **Values**: `true` or `false`   # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProxyCreatePaymentMethod, dict):
