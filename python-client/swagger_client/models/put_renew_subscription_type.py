...
class PUTRenewSubscriptionType(object):
    ...
    def __init__(self, apply_credit_balance=None, collect=None, document_date=None, invoice=None, invoice_collect=None, invoice_target_date=None, run_billing=False, target_date=None):  # noqa: E501
